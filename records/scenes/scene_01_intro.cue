			...
			infos: [
				{
					...
					responses: [
						...
						{text: "I'll pull the bare bones into the landing pad back there, and you put the soul into the machine. Match the client's requirements, and we're golden.", voice: true},
