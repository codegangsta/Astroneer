...
mission_texts: list.Concat([
		(#MessageList & {in: {
		prefix: "MissionTextFighter"
		form_lists: ["MissionTextsFighter"]
		messages: [
	...
	(#MessageList & {in: {
		prefix: "MissionTextExplorer"
		form_lists: ["MissionTextsExplorer"]
		messages: [
	...
	(#MessageList & {in: {
		prefix: "MissionTextHauler"
		form_lists: ["MissionTextsHauler"]
		messages: [
	...
	(#MessageList & {in: {
		prefix: "MissionTextInterceptor"
		form_lists: ["MissionTextsInterceptor"]
		messages: [
	...
	(#MessageList & {in: {
		prefix: "MissionTextLuxury"
		form_lists: ["MissionTextsLuxury"]
		messages: [
